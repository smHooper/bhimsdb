...
CREATE TABLE data_entry_config (
    park_unit_code CHAR(4),
    park_unit_name VARCHAR(255),
    entry_form_title VARCHAR(255),
    entry_form_description_html TEXT,
    entry_pre_submission_message TEXT,
    entry_post_submission_message TEXT,
    allow_file_attachments BOOLEAN,
    map_has_vector_overlay BOOLEAN,
    defailt_map_center_latitude REAL,
